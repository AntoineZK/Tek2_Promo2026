...
RT::Parsing::Sphere::Sphere() : _pos(0), _radius(0), _material(""), _material_color(3), _material_reflection(0), _grp("")
{
}

RT::Parsing::Sphere::~Sphere()
{
}

std::string RT::Parsing::Sphere::getName() const
{
    return ("Sphere");
}

std::string RT::Parsing::Sphere::getMaterial() const
{
    return (_material);
}

std::vector<double> RT::Parsing::Sphere::getMaterialColor() const
{
    return (_material_color);
}

double RT::Parsing::Sphere::getMaterialReflection() const
{
    return (_material_reflection);
}

double RT::Parsing::Sphere::getRadius() const
{
    return (_radius);
}

double RT::Parsing::Sphere::getHeight() const
{
    return (0);
}

std::string RT::Parsing::Sphere::getNameRect() const
{
    return ("");
}

double RT::Parsing::Sphere::getK() const
{
    return (0);
}

void RT::Parsing::Sphere::create(libconfig::Setting& sphere)
{
    if (!sphere.exists("position") || !sphere.exists("material"))
        return;
    ...
    if (sphere.exists("radius"))
        sphere.lookupValue("radius", _radius);
...
void RT::Parsing::Sphere::set(std::vector<double> pos, std::string material, std::vector<double> material_color, double material_reflection)
{
    (void) pos;
    (void) material;
    (void) material_color;
...
void RT::Parsing::Sphere::add(std::vector<double> pos, std::vector<double> rotate)
{
    (void) rotate;
    if (pos.size() != 3) {
...
void RT::Parsing::Sphere::add(std::vector<double> pos, std::string name)
{
    if (pos.size() != 3) {
        std::cerr << "Invalid position" << std::endl;
        return;
...
std::vector<double> RT::Parsing::Sphere::getPosRot(std::string name) const
{
    if (name == (std::string)"position")
        return (_pos);
...
std::string RT::Parsing::Sphere::getGroup() const
{
    return (_grp);
}

void RT::Parsing::Sphere::setGroup(std::string grp)
{
    _grp = grp;
}